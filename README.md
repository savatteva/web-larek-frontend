...
Класс отвечает за хранение данных и логику работы с данными карточек. 

`constructor( _cards: ICard[], _preview: string | null, events: IEvents)`- конструктор класса принимает массив карточек, id карточки и инстант брокера событий.
...
Класс отвечает за хранение данных и логику работы с корзиной. 
Конструктор класса принимает инстант брокера событий. 

`constructor (payment: string, email: string, phone: string, address: string, total: number, items: ICard[], events: IEvents)` - конструктор класса принимает тип оплаты,  email, телефон, адрес, сумму заказа, массив товаров и инстант брокера событий.
...
`constructor (element: HTMLElement, events: IEvents)` -   конструктор класса передается DOM-элемент темплейта, что позволяет при необходимости формировать карточки разных вариантов верстки и экземпляр `EventEmitter` для инициации событий
